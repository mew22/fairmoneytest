package com.sdelaherche.fairmoneytest.common.util

/**
 * Custom Result class as Kotlin.Result class currently has some bugs for unit test
 */
 ...
 * Returns the original `Result` unchanged.
 */
@Suppress("ExperimentalContracts")
